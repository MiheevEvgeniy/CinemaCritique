...
class FilmorateApplicationTests {
    ...
    public void testAddUser() {
        userStorage.add(User.builder().name("Test user").build());
    ...
    public void testUpdateUser() {
        userStorage.update(User.builder().id(1).name("Test user2").build());
    ...
    public void testAddFilm() {
        filmStorage.add(Film.builder().name("Test film").build());
    ...
    public void testUpdateFilm() {
        filmStorage.update(Film.builder().id(1).name("Test film2").build());
